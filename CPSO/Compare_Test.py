...
def compare_test():
    ...
    compare_pso = CPSO(env.agent_num*2, 30, 30, fn_lb=fn_lb, fn_ub=fn_ub, v_low=-3, v_high=3, env=env)
    ...
    for ep in range(0, total_test_episodes):
        ...
        # 注意map_index为1的时候starting points要设为none
