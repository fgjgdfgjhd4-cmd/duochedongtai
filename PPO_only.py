...
class PPO:
    ...
    def update(self):
        ...
        old_logprobs = torch.squeeze(torch.stack(self.buffer.state_values, dim=0)).detach().to(device)
        ...
        for _ in range(self.K_epochs):
            ...
            # print("old states shape: {}".format(old_states.shape))
            # print("old actions shape: {}".format(old_actions.shape))
